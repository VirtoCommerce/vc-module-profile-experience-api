...
public abstract class BaseAddressesQueryBuilder<TQuery> : SearchQueryBuilder<TQuery, MemberAddressSearchResult, MemberAddress, MemberAddressType>
    where TQuery : BaseAddressesQuery
{
